...
export const useMaterialReactTable = <TData extends MRT_RowData>({
  ...
  const table = useMaterialReactTableMRT({
    ...
    onColumnFiltersChange: (updaterValue) => {
      const value = typeof updaterValue === "function" ? updaterValue(state[id].columnFilters) : updaterValue;
    ...
    onColumnOrderChange: (updaterValue) => {
      const value = typeof updaterValue === "function" ? updaterValue(state[id].columnOrder) : updaterValue;
    ...
    onRowSelectionChange: (updaterValue) => {
      const value =
        typeof updaterValue === "function" ? updaterValue(state[id].rowSelection ?? {}) : updaterValue;
      setRowSelection(id, value);
    },

    onColumnSizingChange: (updaterValue) => {
      const value = typeof updaterValue === "function" ? updaterValue(state[id].columnSizing) : updaterValue;
    ...
    onColumnVisibilityChange: (updaterValue) => {
      const value =
        typeof updaterValue === "function" ? updaterValue(state[id].columnVisibility ?? {}) : updaterValue;
