...
namespace LNSF.Test.Utils;

public class HttpClientUtil
{
	public string _accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6ImF0K2p3dCJ9.eyJuYW1laWQiOiIyIiwidW5pcXVlX25hbWUiOiJhZG1pbmlzdHJhZG9yIiwicm9sZSI6IkFkbWluaXN0cmFkb3IiLCJuYmYiOjE3MzE5MjQyMDQsImV4cCI6MTczMjUyOTAwNCwiaWF0IjoxNzMxOTI0MjA0LCJpc3MiOiJodHRwOi8vbG9jYWxob3N0OjUwNjUiLCJhdWQiOiJodHRwOi8vbG9jYWxob3N0OjUwNjUifQ.AFSTeFrJ56LzNmzufJUH5p8Uwm6u7m09T3jyzpGqK6A";
	...
	/// </summary>
	public async Task<T> GetFromQuery<T>(HttpClient client, dynamic? filter = null) where T : class
	{
		var query = BuildQuery(filter ?? new { });
	...
	public virtual async Task<MultipartFormDataContent> FormContent(MultipartFormDataContent formData, dynamic obj, string? entityName = null)
	{
		foreach (var property in obj.GetType().GetProperties())
		{
			...
			if (property!.PropertyType.Namespace == "LNSF.Domain.Entities")
