...
import { Account, Dashboard, LoginPage, PersonalData, PutAllPasseio, RegisterPatients, RegisterRoom, RegisterTour, TelaDeGerenciamentoAccount, TelaDeGerenciamentoPeople, TelaDeGerenciamentoRoom, ViewPatients, ViewPeople, ViewRoom, ViewTour } from '../Pages/index';
        ...
        <>
            <Routes>
                ...
                <Route element={<ProtectedRoutes />}>
                    ...
                    {user.role !== 0 && <Route path="/inicio/pessoas/visualizar/teste" element={<Dashboard children={<ViewPatients />} />} />}
                    ...
                    {user.role !== 0 && <Route path="/inicio/pessoas/gerenciar" element={<Dashboard children={<RegisterPatients />} />} />}
