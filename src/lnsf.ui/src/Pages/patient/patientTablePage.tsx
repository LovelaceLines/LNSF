  ...
  const columns = useMemo<MRT_ColumnDef<patient>[]>(
    () => [
      ...
      },
      {
        ...
        header: "Id Pessoa",
        Cell: ({ row }) => (
          <MRTLaunchLink label={row.original.peopleId} to={`/app/pessoas/${row.original.peopleId}`} />
        ),
      },
      {
      ...
      },
      {
        ...
        header: "Id Hospital",
        Cell: ({ row }) => (
          <MRTLaunchLink label={row.original.hospitalId} to={`/app/hospitais/${row.original.hospitalId}`} />
        ),
      },
      {
