...
public class EmergencyContactService : IEmergencyContactService
{
    ...
    public async Task<EmergencyContact> Update(EmergencyContact newContact)
    {
        ...
        if (!await _emergencyContactRepository.ExistsByIdAndPeopleId(newContact.Id, newContact.PeopleId)) throw new AppException("Contato de emergência ou pessoa não encontrado!", HttpStatusCode.NotFound);
